...
export default function App() {
  ...
  if (!showLanding && !activeGroup && isResolvingSharedGroup) {
    return (
      <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#090d16] flex flex-col items-center justify-center gap-4 p-6 text-center">
        <Logo size={40} />
        <Loader2 className="w-5 h-5 text-[#6FA4EA] dark:text-[#A5CFF6] animate-spin" />
        <p className="text-xs text-[#6FA4EA] dark:text-[#A5CFF6] font-medium">
          Loading this split…
        </p>
      </div>
    );
  ...
  if (!showLanding && !activeGroup && !isResolvingSharedGroup) {
    return (
      <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#090d16] flex flex-col items-center justify-center gap-4 p-6 text-center">
        <Logo size={40} />
        <div className="w-14 h-14 rounded-full bg-[#E9EFF8] dark:bg-[#203652] text-[#11213C] dark:text-[#A5CFF6] flex items-center justify-center border border-[#DCE6F1] dark:border-[#2A4365]">
          <SearchX className="w-6 h-6" />
        </div>
        <div>
          <h2 className="font-display text-2xl text-[#11213C] dark:text-white">
            Split not found
          </h2>
          <p className="text-xs text-[#6FA4EA] dark:text-[#A5CFF6] mt-1 max-w-xs">
            This link doesn't match any split we can find. Double-check the link, or start a new one.
          </p>
        </div>
        <button
          onClick={handleGoHome}
          className="mt-2 px-6 py-3 bg-[#11213C] dark:bg-white text-white dark:text-[#11213C] rounded-full text-xs font-semibold hover:opacity-90 transition-opacity cursor-pointer"
        >
          Go to nooswise home
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#0c1524] text-[#11213C] dark:text-[#F8F9FB] flex flex-col md:flex-row antialiased selection:bg-[#A5CFF6] dark:selection:bg-[#203652] transition-colors">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
            ...
            {isRenamingGroup ? (
              ...
              >
                <input
                  ...
                  className="bg-white dark:bg-[#11213C] text-[#11213C] dark:text-white font-display text-2xl sm:text-3xl px-3 py-1 rounded-xl border border-[#DCE6F1] dark:border-[#2A4365] focus:outline-none focus:ring-2 focus:ring-[#7AC5F9]"
                />
                <button
                  type="submit"
                  className="w-8 h-8 rounded-full bg-[#11213C] dark:bg-white text-white dark:text-[#11213C] flex items-center justify-center cursor-pointer shadow-xs"
                >
              ...
              >
                <h2 className="font-display text-2xl sm:text-3xl lg:text-4xl text-[#11213C] dark:text-white tracking-tight group-hover:opacity-85 transition-opacity">
                  {activeGroup.name}
                </h2>
                <ChevronDown
                  className={`w-4 h-4 text-[#6FA4EA] transition-transform ${
            ...
            <AnimatePresence>
              {isGroupDropdownOpen && !isRenamingGroup && (
                <motion.div
                  ...
                  className="absolute z-50 left-0 top-full mt-2 w-72 bg-white dark:bg-[#11213C] rounded-2xl shadow-2xl border border-[#DCE6F1] dark:border-[#2A4365] p-2 flex flex-col gap-1"
                >
                  <div className="flex items-center justify-between px-2 py-1.5 border-b border-[#DCE6F1] dark:border-[#2A4365]">
                    ...
                    <button
                      ...
                      className="text-[11px] font-semibold text-[#11213C] dark:text-white hover:underline flex items-center gap-1 cursor-pointer"
                    >
                      <Edit2 className="w-3 h-3 text-[#6FA4EA]" />
                      <span>Rename</span>
                    </button>
                  </div>
                        ...
                        <button
                          ...
                          className={`flex items-center justify-between p-2 rounded-xl text-left transition-colors cursor-pointer ${
                            isSelected
                              ...
                              : 'hover:bg-[#F8F9FB] dark:hover:bg-[#203652]/60 text-[#11213C] dark:text-[#F8F9FB]'
                          }`}
                        >
                          <div className="flex flex-col min-w-0">
                            ...
                            <span className="text-[10px] text-[#6FA4EA]">
                              {(g.members || []).length} friends • {(g.expenses || []).length} items
                            </span>
                          </div>
                          {isSelected && (
                            <Check className="w-3.5 h-3.5 text-[#11213C] dark:text-[#A5CFF6]" />
                          )}
                        </button>
                      );
                    })}
                  ...
                  <button
                    ...
                    className="mt-1 flex items-center justify-center gap-1.5 p-2 rounded-xl bg-[#F8F9FB] dark:bg-[#203652] hover:bg-[#E9EFF8] dark:hover:bg-[#2A4365] text-xs font-semibold text-[#11213C] dark:text-white border border-[#DCE6F1] dark:border-[#2A4365] cursor-pointer transition-colors"
                  >
          ...
          <div className="flex items-center gap-2 sm:gap-3 self-start sm:self-auto">
            <motion.button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-semibold bg-white dark:bg-[#11213C] hover:bg-[#E9EFF8] dark:hover:bg-[#203652] text-[#11213C] dark:text-white border border-[#DCE6F1] dark:border-[#2A4365] shadow-2xs transition-colors cursor-pointer"
            >
            ...
            {activeTab === 'expenses' && (
              ...
              >
                ...
                {activeGroup.isArchived && (
                  <div className="bg-[#E9EFF8] dark:bg-[#11213C] border border-[#DCE6F1] dark:border-[#2A4365] rounded-[22px] p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs shadow-2xs">
                    <div className="flex items-center gap-2.5 text-[#11213C] dark:text-[#F8F9FB]">
                      <span className="w-8 h-8 rounded-full bg-[#A5CFF6] dark:bg-[#203652] text-[#11213C] dark:text-[#A5CFF6] flex items-center justify-center shrink-0">
                      ...
                      <div>
                        ...
                        <span className="text-[#6FA4EA] dark:text-slate-400">
                    ...
                    <div className="flex items-center gap-2 self-end sm:self-auto shrink-0">
                      <motion.button
                        ...
                        className="px-3.5 py-1.5 rounded-full bg-[#6FA4EA] text-[#11213C] font-semibold hover:opacity-90 transition-opacity cursor-pointer"
                      >
                        View Recap
                      </motion.button>
                      <motion.button
                        ...
                        className="px-3.5 py-1.5 rounded-full bg-white dark:bg-[#203652] text-[#11213C] dark:text-white border border-[#DCE6F1] dark:border-[#2A4365] font-semibold hover:bg-[#F8F9FB] transition-colors cursor-pointer"
                      >
                        Unarchive
                      </motion.button>
                    </div>
                ...
                <div className="flex flex-col gap-5 pt-1">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="font-semibold text-lg md:text-xl text-[#11213C] dark:text-white">
                        What we spent
                      </h3>
                      <p className="text-xs text-[#6FA4EA] dark:text-[#A5CFF6]">
                    ...
                    <motion.button
                      ...
                      className="flex items-center gap-2 px-5 py-2.5 bg-[#11213C] dark:bg-white text-white dark:text-[#11213C] rounded-full text-xs md:text-sm font-semibold hover:opacity-90 transition-opacity shadow-sm cursor-pointer group"
                    >
                      <Plus className="w-4 h-4" />
                      <span>Add expense</span>
                      <kbd className="hidden sm:inline-flex items-center text-[10px] font-mono px-1.5 py-0.5 rounded bg-white/20 dark:bg-[#11213C]/20 text-white/90 dark:text-[#11213C]/90 font-semibold ml-0.5">
                        E
                      </kbd>
                    </motion.button>
                  </div>
                  ...
                  {(activeGroup.expenses || []).length === 0 ? (
                    <div className="bg-white dark:bg-[#11213C] rounded-[30px] p-10 text-center border border-[#DCE6F1] dark:border-[#2A4365] flex flex-col items-center justify-center gap-3 brand-card-shadow">
                      <div className="w-12 h-12 rounded-full bg-[#E9EFF8] dark:bg-[#203652] flex items-center justify-center text-[#11213C] dark:text-[#A5CFF6] border border-[#DCE6F1] dark:border-[#2A4365]">
                        <Receipt className="w-6 h-6" />
                      </div>
                      <h4 className="font-display text-2xl text-[#11213C] dark:text-white font-normal">
                        Nothing recorded yet
                      </h4>
                      <p className="text-xs text-[#6FA4EA] dark:text-[#A5CFF6] max-w-sm">
                      ...
                      <motion.button
                        ...
                        className="mt-2 bg-[#11213C] dark:bg-white text-white dark:text-[#11213C] text-xs font-semibold px-6 py-2.5 rounded-full hover:opacity-90 transition-opacity flex items-center gap-2 cursor-pointer shadow-md"
                      >
                        <Plus className="w-3.5 h-3.5" />
                        <span>Add expense</span>
                      </motion.button>
      ...
      <AnimatePresence>
        {liveToast && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-4 py-3 bg-[#11213C]/95 dark:bg-white/95 text-white dark:text-[#11213C] rounded-full shadow-xl border border-[#3B5B88] dark:border-slate-200 backdrop-blur-md text-xs font-semibold pointer-events-none"
          >
